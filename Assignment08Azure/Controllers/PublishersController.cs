...
namespace Assignment08Azure.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PublisherId,PublisherName,PublisherAddress,MobileNumber")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PublisherId,PublisherName,PublisherAddress,MobileNumber")] Publisher publisher)
        {
